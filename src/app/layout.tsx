...
export const metadata: Metadata = {
  ...
  description: "Big Sandy regional public-safety news and attributed public booking records with correction-request access.",
  metadataBase: new URL("https://BigSandyCrimeWatch.com"),
  alternates: { canonical: "/" },
  openGraph: {
    title: "Big Sandy Crime Watch",
    description: "Big Sandy regional public-safety news and attributed public booking records.",
