...
export const counties=["johnson","martin","magoffin","lawrence","pike"];export const categories=["bookings","drug-arrests","dui","public-intoxication","serious-charges","breaking-news","public-safety"];
